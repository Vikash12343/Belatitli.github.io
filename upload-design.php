<?php
	...
	<title>Image Upload - BelaTitli-Kalkatta</title>
	<style>
		...
		.main .nav-link{background: #27a465; color: #f7f7f7; margin-top:5px; padding:12px; 
					border: none; border-radius: 3px; width:300px; text-align:center; text-decoration:none;}
		.main .nav-item{width:300px;}
		.main .navbar-nav{list-style:none;}
		...
		<div class="image-box">
			...
			<form method="POST" name="upfrm" action="" enctype="multipart/form-data">
				<div>
					...
					<ul class="navbar-nav">
                  <li class="nav-item"> <a class="nav-link" href="index.html">Go To home Page..!</a></li>
